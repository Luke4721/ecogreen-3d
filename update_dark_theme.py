...
<head>
  ...
  <title>Eco Green Recyclers - Dark Emerald</title>
...
<body>
  ...
  <!-- PART 1: PREMIUM NAVIGATION BAR -->
  <nav class="navbar">
    <div class="nav-container">
      <!-- Logo -->
      <a href="#" class="logo">
        <span class="logo-icon">☘️</span>
        <span class="logo-text">Eco<span class="text-emerald">Green</span></span>
      </a>
  ...
  <main class="ui-layer">
    ...
    <!-- SECTION 1: HERO -->
    <section id="home" class="section hero hero-gradient">
      ...
      <div class="container">
        ...
        <div class="grid three-col mt-4">
          <div class="glass-card reveal">
            ...
            <p class="text-secondary">million tonnes of e-waste India generates every year — the world's third-largest pile.</p>
          </div>
          <div class="glass-card reveal" style="transition-delay: 0.1s;">
            ...
            <p class="text-secondary">one in five devices handed to informal recyclers ends up burnt in the open.</p>
          </div>
          <div class="glass-card reveal" style="transition-delay: 0.2s;">
            ...
            <p class="text-secondary">million tonnes of embodied carbon thrown away with unrecycled circuitry — ore we already mined</p>
          </div>
        </div>
        <p class="source-text reveal mt-4 text-center">GLOBAL E-WASTE MONITOR 2024 • CPCB ANNUAL REPORT</p>
      </div>
    </section>

    <!-- SECTION 3: "A FIGHT FOR WHAT'S NEXT" -->
    <section id="sustainability" class="section bg-secondary">
      <div class="container grid two-col align-center">
        <div class="reveal">
          <h2 class="section-title text-gradient">A fight for what's next.</h2>
          <p class="text-lg text-secondary">Every retired device is a choice: a landfill burning in the open, or a vault of metals re-entering the economy. Ecogreen exists to make the second choice the easy one — certified, tracked and reported end to end, for enterprises that answer to their own ESG commitments.</p>
        </div>
        <div class="glass-card reveal" style="transition-delay: 0.2s;">
          <p class="label label-accent">GREEN METALS RECOVERED</p>
          <p class="text-secondary mt-2">Every retired asset is a vein of ore we have already mined once. Recovering it is the cheapest, cleanest tonne of metal on Earth.</p>
          ...
          <a href="#services" class="btn btn-outline mt-4">EXPLORE GREEN METAL RECOVERY &rarr;</a>
        </div>
      </div>
    </section>

    <!-- SECTION 4: MARQUEE BANNER -->
    <div class="marquee-section bg-secondary border-y">
        <h2 class="marquee-text">TAKE ACTION <span class="text-emerald">&</span> RECYCLE RIGHT &nbsp;&nbsp;&nbsp; TAKE ACTION <span class="text-emerald">&</span> RECYCLE RIGHT &nbsp;&nbsp;&nbsp; TAKE ACTION <span class="text-emerald">&</span> RECYCLE RIGHT &nbsp;&nbsp;&nbsp; TAKE ACTION <span class="text-emerald">&</span> RECYCLE RIGHT &nbsp;&nbsp;&nbsp; TAKE ACTION <span class="text-emerald">&</span> RECYCLE RIGHT &nbsp;&nbsp;&nbsp; TAKE ACTION <span class="text-emerald">&</span> RECYCLE RIGHT &nbsp;&nbsp;&nbsp; TAKE ACTION <span class="text-emerald">&</span> RECYCLE RIGHT &nbsp;&nbsp;&nbsp; TAKE ACTION <span class="text-emerald">&</span> RECYCLE RIGHT</h2>
    </div>
    ...
    <section class="section">
      <div class="container text-center">
        ...
        <h2 class="section-title text-gradient reveal">The extraction figures behind every batch</h2>
        
        <div class="grid two-col mt-4">
          <div class="glass-card extraction-card reveal">
            <h3 class="highlight-stat">98%+</h3>
            <h4 class="mt-2 text-white">EXTRACTION EFFICIENCY</h4>
            <p class="mt-2 text-secondary">Safe discharge and hydrometallurgical recovery of cobalt, lithium and nickel.</p>
          </div>
          <div class="glass-card extraction-card reveal" style="transition-delay: 0.2s;">
            <h3 class="highlight-stat">99.5%</h3>
            <h4 class="mt-2 text-white">Purity level of recovered metals</h4>
            <p class="mt-2 text-secondary">returned to the supply chain</p>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="flex-between reveal">
          <div>
            ...
            <h2 class="section-title text-gradient" style="margin-bottom: 0;">Expert collection, recycling, and disposal</h2>
          </div>
    ...
    <section class="section text-center bg-secondary">
    ...
    <section class="section bg-secondary pt-0">
      <div class="container text-center reveal">
        ...
        <h2 class="section-title text-gradient">Trusted by Industry Leaders</h2>
        <p class="text-lg mx-auto text-secondary" style="max-width: 800px;">Partnering with global brands to ensure secure, compliant, and zero-waste IT asset disposition and green metal recovery.</p>
    ...
    <section id="about" class="section">
      <div class="container">
        <div class="reveal text-center mb-5">
          ...
          <h2 class="section-title text-gradient mx-auto" style="max-width: 900px;">Empowering sustainable futures through responsible e-waste management and recycling solutions.</h2>
        </div>

        <div class="grid three-col mt-5">
          <div class="glass-card reveal">
            <h3 class="highlight-stat">98%+</h3>
            <p class="text-secondary mt-2 mb-4">Extraction efficiency on e-waste and lithium-ion cells</p>
          ...
          <div class="glass-card reveal" style="transition-delay: 0.1s;">
            ...
            <p class="text-secondary mt-2 mb-4">Partner organizations across industrial and e-waste plastic recovery streams</p>
            <ul class="process-list text-secondary">
          ...
          <div class="glass-card reveal" style="transition-delay: 0.2s;">
            ...
            <p class="text-secondary mt-2">Distinct green metals recovered from e-waste at greater than 99.5% purity, reintegrated into manufacturing supply chains.</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <div class="marquee-section transparent-bg border-y">
        <h2 class="marquee-text outline-text">RECYCLING &nbsp;&bull;&nbsp; GOGREEN &nbsp;&bull;&nbsp; ECOCONSCIOUS &nbsp;&bull;&nbsp; SUSTAINABILITY &nbsp;&bull;&nbsp; ECOFRIENDLY &nbsp;&bull;&nbsp; GREENLIVING &nbsp;&bull;&nbsp; RECYCLING &nbsp;&bull;&nbsp; GOGREEN &nbsp;&bull;&nbsp; ECOCONSCIOUS &nbsp;&bull;&nbsp; SUSTAINABILITY &nbsp;&bull;&nbsp; ECOFRIENDLY &nbsp;&bull;&nbsp; GREENLIVING &nbsp;&bull;&nbsp; RECYCLING &nbsp;&bull;&nbsp; GOGREEN &nbsp;&bull;&nbsp; ECOCONSCIOUS &nbsp;&bull;&nbsp; SUSTAINABILITY &nbsp;&bull;&nbsp; ECOFRIENDLY &nbsp;&bull;&nbsp; GREENLIVING &nbsp;&bull;&nbsp; RECYCLING &nbsp;&bull;&nbsp; GOGREEN &nbsp;&bull;&nbsp; ECOCONSCIOUS &nbsp;&bull;&nbsp; SUSTAINABILITY &nbsp;&bull;&nbsp; ECOFRIENDLY &nbsp;&bull;&nbsp; GREENLIVING</h2>
    </div>
    ...
    <section class="section bg-secondary">
      <div class="container">
        <div class="text-center reveal">
          ...
          <h2 class="section-title text-gradient">Certifications & Achievements</h2>
        </div>
        
        <div class="grid three-col mt-4">
          <div class="glass-card reveal">
            <h3>ISO Certification</h3>
            <p class="mt-2 text-secondary">Ensuring operational excellence, rigorous quality management, and strict environmental compliance across all asset disposition facilities.</p>
          </div>
          <div class="glass-card reveal" style="transition-delay: 0.1s;">
            <h3>Global Recycled Standard</h3>
            <p class="mt-2 text-secondary">Verifying safe, equitable, and transparent supply chains from end-of-life processing all the way to secondary raw material production.</p>
          </div>
          <div class="glass-card reveal" style="transition-delay: 0.2s;">
            <h3>Green Air Standard</h3>
            <p class="mt-2 text-secondary">Maintaining industry-leading emission controls and zero-harm atmospheric processing during complex metal extraction and dismantling.</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <!-- SECTION 13: FAQ -->
    <section class="section pt-0 bg-secondary">
      <div class="container max-w-800">
        <div class="text-center reveal">
          <p class="label label-accent">LOOKING FORWARD</p>
          <h2 class="section-title text-gradient">Future Vision & FAQs</h2>
        </div>
    ...
    <section class="section text-center py-10">
      <div class="container">
        <h2 class="quote-text text-gradient reveal">"Our vision is a zero-waste future driven by continuous innovation, where end-of-life technology fuels the next generation of manufacturing."</h2>
      </div>
    </section>

    <!-- SECTION 15: FOOTER -->
    <footer id="contact" class="footer bg-secondary">
      <div class="container">
        <div class="grid four-col">
          <div class="footer-col reveal">
            <h3 class="logo mb-2 text-white">Eco<span class="text-emerald">Green</span></h3>
...
/* Gradients */
.hero-gradient {
  background: linear-gradient(135deg, rgba(11,31,24,0.3) 0%, rgba(27,67,50,0.5) 50%, rgba(6,78,59,0.3) 100%);
}
.text-gradient {
...
.stat-pill-num { font-size: 2.5rem; font-weight: 800; color: var(--accent); line-height: 1; text-shadow: 0 0 10px rgba(16, 185, 129, 0.4); }
.stat-pill-label { font-size: 0.8rem; font-weight: 700; letter-spacing: 0.1em; color: var(--white); margin-top: 0.25rem; }
...
.hover-white:hover { color: var(--accent-glow); text-decoration: underline; }

/* Glassmorphism Cards */
.glass-card {
  background: linear-gradient(180deg, rgba(27,67,50,0.8) 0%, rgba(27,67,50,0.4) 100%);
  backdrop-filter: blur(20px); -webkit-backdrop-filter: blur(20px);
  border: 1px solid var(--glass-border); border-radius: 24px;
  padding: 2.5rem; box-shadow: 0 8px 32px rgba(0, 0, 0, 0.2);
...
.source-text { font-size: 0.7rem; font-weight: 700; opacity: 0.6; letter-spacing: 0.1em; color: var(--text-secondary); }
...
.metal-tags span { 
  ...
  border: 1px solid var(--accent); color: var(--accent-glow); 
  box-shadow: 0 0 10px rgba(16, 185, 129, 0.2);
}
.metal-pill-list { justify-content: center; align-items: center; font-size: 1.5rem; font-weight: 600; color: var(--white); }
.metal-pill-list span { color: var(--accent); text-shadow: 0 0 10px rgba(16,185,129,0.3); }

/* Marquee */
.marquee-section { padding: 2rem 0; overflow: hidden; white-space: nowrap; }
...
.outline-text { color: transparent; -webkit-text-stroke: 1px var(--text-secondary); }
@keyframes scrollText { 0% { transform: translateX(0); } 100% { transform: translateX(-50%); } }

/* Partners Marquee */
.partners-marquee { overflow: hidden; white-space: nowrap; padding: 1.5rem 0 !important; }
.partners-track { display: inline-block; animation: scrollText 30s linear infinite; font-weight: 800; font-size: 1.5rem; letter-spacing: 0.1em; color: rgba(209, 250, 245, 0.4); }
.partners-track span { margin: 0 2rem; color: var(--text-primary); }
...
.accordion-item { padding: 2rem; cursor: pointer; }
...
.footer-legal a { margin-left: 1rem; color: var(--text-secondary); }
...
script_content = """document.addEventListener('DOMContentLoaded', () => {
    ...
    /* ═══════════════════════════════════════════════════════════════════════════
       3. THREE.JS HYBRID BACKGROUND: LIQUID METAL + DATA AURORA (DARK THEME)
       ═══════════════════════════════════════════════════════════════════════════ */
    ...
    scene.background = new THREE.Color('#0B1F18'); // Deep Forest Green
    scene.fog = new THREE.FogExp2(0x0B1F18, 0.03); // Added fog for depth
    ...
    // Light Setup - Adjusted for high contrast dark theme
    const ambientLight = new THREE.AmbientLight(0xffffff, 0.2); // reduced ambient
    scene.add(ambientLight);

    const keyLight = new THREE.DirectionalLight(0xffffff, 2.0); // stronger key
    keyLight.position.set(5, 8, 5);
    scene.add(keyLight);

    const fillLight = new THREE.DirectionalLight(0x10B981, 1.2); // stronger emerald fill
    fillLight.position.set(-5, 3, 3);
    scene.add(fillLight);

    const goldAccent = new THREE.PointLight(0xFFD700, 1.5, 50); // stronger rim
    goldAccent.position.set(-3, -5, 2);
    scene.add(goldAccent);

    const backGlow = new THREE.PointLight(0x34D399, 1.0, 50);
    ...
    const auroraMat = new THREE.MeshPhysicalMaterial({
        color: 0x10B981, transmission: 0.9, opacity: 0.4,
        roughness: 0.1, metalness: 0.2, transparent: true, side: THREE.DoubleSide
    });
    const auroraMatLight = new THREE.MeshPhysicalMaterial({
        color: 0x34D399, transmission: 0.9, opacity: 0.3,
        roughness: 0.1, metalness: 0.2, transparent: true, side: THREE.DoubleSide
    });
    ...
    for(let i=0; i<particleCount; i++) {
        ...
        pOpacities[i] = 0.4 + Math.random() * 0.6; // brighter for dark mode
    ...
    const pMat = new THREE.PointsMaterial({
        color: 0x34D399, size: 0.08, transparent: true, opacity: 0.8,
    ...
    function animate() {
        ...
        const targetAuroraY = -(scrollProgress * 4);
...
print("Applied Dark Emerald theme successfully!")
