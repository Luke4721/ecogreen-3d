...
<span class="logo-icon">☘️</span><span class="logo-text">Eco<span class="text-emerald">Green</span></span>
</a>
<ul class="nav-menu">
...
<h3 class="logo mb-2 text-white"><span class="logo-text">Eco<span class="text-emerald">Green</span></span></h3>
...
<div class="grid three-col mt-4">
<div class="glass-card reveal"><h3>ISO Certification</h3></div>
<div class="glass-card reveal" style="transition-delay:0.1s;"><h3>Global Recycled Standard</h3></div>
<div class="glass-card reveal" style="transition-delay:0.2s;"><h3>Green Air Standard</h3></div>
</div>
...
<div class="glass-card reveal" style="transition-delay: 0.2s; min-height: 300px; background: url('https://images.unsplash.com/photo-1550005973-78ce3f78fa45?w=800') center/cover;">
</div>
</div>
</section>
<section class="section bg-secondary">
...
<div class="service-image-card glass-card reveal">
<img src="https://images.unsplash.com/photo-1550005973-78ce3f78fa45?w=800&q=80" alt="E-Waste">
<div class="card-content">
<h3>E-Waste Management</h3>
...
<div class="service-image-card glass-card reveal" style="transition-delay:0.1s;">
<img src="https://images.unsplash.com/photo-1620802051778-e8cb5043ccbc?w=800&q=80" alt="Battery">
<div class="card-content">
<h3>Lithium Battery Recycling</h3>
...
<div class="service-image-card glass-card reveal" style="transition-delay:0.2s;">
<img src="https://images.unsplash.com/photo-1532996122724-e3c354a0b15b?w=800&q=80" alt="Plastic">
<div class="card-content">
<h3>Plastic Waste Recycling</h3>
...
<div class="service-image-card glass-card reveal">
<img src="https://images.unsplash.com/photo-1603351154351-5e2d0600bb77?w=800&q=80" alt="Paper">
<div class="card-content">
...
<div class="service-image-card glass-card reveal" style="transition-delay:0.1s;">
<img src="https://images.unsplash.com/photo-1581093458791-9f3c3900df4b?w=800&q=80" alt="Metal">
<div class="card-content">
...
<div class="service-image-card glass-card reveal" style="transition-delay:0.2s;">
<img src="https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=800&q=80" alt="EPR">
<div class="card-content">
...
<div class="glass-card"><h3 class="highlight-stat">1.6Mt</h3><p>E-waste processed</p></div>
<div class="glass-card"><h3 class="highlight-stat">98%+</h3><p>Extraction efficiency</p></div>
<div class="glass-card"><h3 class="highlight-stat">99.5%</h3><p>Purity</p></div>
<div class="glass-card"><h3 class="highlight-stat">342+</h3><p>Happy clients</p></div>
<div class="glass-card"><h3 class="highlight-stat">84</h3><p>Partners</p></div>
<div class="glass-card"><h3 class="highlight-stat">10+</h3><p>Years experience</p></div>
</div>
</div>
</section>
<section class="section">
...
<p class="text-secondary mb-2"><strong>Phone:</strong> +91 93192 53708</p>
<p class="text-secondary mb-4"><strong>Email:</strong> operation@ecogreen.eco</p>
<div class="map-placeholder mt-4 mb-4" style="height: 200px; background: rgba(0,0,0,0.2); border-radius:12px; display:flex; align-items:center; justify-content:center; border: 1px solid rgba(16,185,129,0.2);">
<span class="text-secondary">[ Google Maps Embed ]</span>
</div>
...
print("Generated 13 pages successfully.")
